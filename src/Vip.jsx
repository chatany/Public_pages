...
export const Vip = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-black">
      <div
        className=" bg-cover h-full flex justify-center items-center  bg-center md:min-h-[860px] h-[460px] p-5"
        style={{
          backgroundImage: "url('/bg.png')",
        }}
      >
        <div className="flex flex-col gap-80 p-5">
          <div>
            <div className="flex justify-center">
              <img
                src="vip.svg"
                className="h-[100px] md:h-[150px] w-[220px] w-[360px]"
              />
            </div>
            <div className="flex items-center flex-col p-5 gap-5">
              ...
              <div className="md:text-[18px] text-[12px] font-bold leading-[100%] text-[#686868]  text-center">
                Reach 30,000 USDT in asset balance to become a VIP and enjoy fee
                discounts!
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-4 grid-cols-1 gap-5">
          ...
          <div className="border-[#9C9C9C] border-[1px] rounded-[12px]  min-h-[209px]">
            <div className="flex flex-col gap-2 items-center text-center justify-center h-full w-full">
              <div className="text-[45px]  text-[#FFDFAD] font-bold">300+</div>
              <div className="text-[#686868] text-[12px] font-bold">
                USDT Per user
              </div>
              <div className="text-[20px] font-bold text-white">
              ...
              <div className="text-[#686868] text-[12px] font-bold">
                VIP3 and above can claim new <br /> token airdrops twice a month
              </div>
            </div>
          </div>
          <div className="border-[#9C9C9C] border-[1px] rounded-[12px]  min-h-[209px]">
          ...
          <div className="border-[#9C9C9C] border-[1px] rounded-[12px]  min-h-[209px]">
            <div className="flex flex-col gap-2 items-center justify-center h-full w-full">
              <div className="text-[45px]  text-[#FFDFAD] font-bold">100K+</div>
              <div className="text-[#686868] text-[12px] font-bold">
      ...
      <div className="flex max-md:flex-col justify-between items-center p-5">
        <div></div>
      ...
      <div className="text-[18px] font-medium leading-[29px] text-[#686868] p-10">
        Trading volume from 
        <span className="text-[#FFDFAD]"> zero-fee trading pairs </span>will not
        be counted toward VIP trading volume. For VIP6 and VIP7, API-generated{" "}
      ...
      <div className="flex mt-20 h-full">
        <div className="border-[#ffffff] border-r-[0.5px] w-[45%] p-5 max-md:hidden flex min-h-full flex-col justify-between">
          <div>
            <div>
        ...
        <div className="w-[55%] max-md:w-full  text-left p-15">
          <div className="text-[22px] font-bold whitespace-nowrap mb-5">
            How to apply
          </div>
          <div>
          ...
          <div className="mt-5">
            <div className="mb-5">Contact method</div>
          ...
          <div className="bg-[#131516] flex justify-center items-center h-[116px] w-[116px] rounded-[12px] cursor-pointer  mt-5 border-[0.5px] ">
            <IoIosAdd />
          </div>
          <div className="text-[#686868] mt-5">
            Only PNG, JPG, and JPEG formats are supported. Max size of 10MB per
            file, up to 3 files.
          </div>
