...
export const TradePolicy = () => {
  return (
    <div>
      <Helmet>
        <title>BitZup Trading Policy</title>
      ...
      <div className="text-left">
        ...
        <div className="text-left">
          ...
          <div className="text-left font-normal text-base leading-8">
            This Trading Policy outlines the rules, standards, and procedures
            governing the trading of Virtual Digital Assets (VDAs) on the BitZup
...
This policy applies to all users of the BitZup platform, including individual traders, institutional clients, and any third parties interacting with the trading systems of BitZup
       ...
       Users must complete full KYC/AML verification prior to accessing trading services.
        ...
        <div>Crypto-to-Crypto Trading: Exchange between different digital assets.</div>
        <div className="text-left font-semibold text-lg leading-8 mt-8">
        ...
        <div className="text-left font-semibold text-lg leading-8 mt-8">
         SANCTION SCREENING & RESTRICTED JURISDICTIONS
        </div>
        <div className="text-left font-normal text-base leading-8">
