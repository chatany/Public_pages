      ...
      <div className="text-left">
        ...
        <div className="text-left">
          ...
          <div className="text-left font-normal text-sm leading-8">
            ...
            When we request personal information from users, it is either to
            comply with legal obligations or to fulfil specific, legitimate
          ...
          <ul  className="list-disc list-inside">
            ...
            information relating to an identified or identifiable nature person,
            including, but not limited to, a name, an identification number,
            location data, an online identifier or to one or more factors
            specific to the physical, economic, cultural or social id‘BitZup’ of
        ...
        <div>
          To comply with government agencies, including regulators, law
          enforcement and/or justice departments.
        </div>
        <div>
          If such third parties provide services to BitZup (for e.g.,
          administrative or technical service providers)
        </div>
        <div>
          In connection with any sale of BitZup and/or BitZup Services and
          acquisitions of other businesses or services.
        </div>
        <div>
          To protect users or others, this includes but is not limited to
          exchanging information with other companies or organisations for fraud
          protection and credit risk reduction.
        </div>
        <div>
          2. Notwithstanding the foregoing, BitZup may disclose your Personal
          Information to a third party or parties where there is sufficient
          grounds to believe, based on BitZup’s sole discretion, that you have
          violated applicable laws or regulations giving rise to a justification
          of such disclosure, or wherefore the disclosure of Personal
          Information would facilitate the conclusion of, inter alia, a dispute
        ...
        <div className="text-left font-normal text-sm leading-8">
          ...
          authorized way, altered or disclosed. We work to protect the security
          of your personal information during transmission and while stored by
          using encryption protocols and software. We maintain physical,
          electronic and procedural safeguards in connection with the
          collection, storage, and disclosure of your personal information. In
        ...
        <div className="text-left font-normal text-sm leading-8">
          ...
          application to delete your account is bona fide and remind you of the
        ...
        <div className="text-left font-normal text-sm leading-8">
          ...
          However we may retain certain Personal Information pertaining to your
